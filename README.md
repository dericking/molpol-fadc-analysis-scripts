...
This is a repository that will hold work for the HA Moller Polarimeter (MolPol) FADC Analysis and MolPol Data Management. All scripting projects will be kept in their own directory. Main directory should only contain this README.md file.
