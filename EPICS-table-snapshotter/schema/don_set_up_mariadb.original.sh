# Reference copy of Don's setup script. Do not edit this file.
# Source: https://github.com/JeffersonLab/hamoller_analysis_tools/blob/main/set_up_mariadb.sh
# Downloaded 2026-09-08. Proposed EPICS_data changes: don_set_up_mariadb.proposed.sh
